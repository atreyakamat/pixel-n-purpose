...
const services = [
  {
    ...
    description:
      "We build immersive digital flagships. Beyond aesthetics, our websites are engineered for conversion, speed, and seamless user journeys. We strip away the noise to reveal your brand's essence.",
  ...
  },
  {
    ...
    description:
      'For artists, architects, and visionaries. We create digital galleries that honor your work. Minimalist frameworks that allow your projects to breathe and speak for themselves.',
  ...
  },
  {
    ...
    description:
      'Tactile experiences that elevate the unboxing ritual. We design sustainable, high-impact packaging systems that translate your digital brand into physical reality.',
  ...
  },
  {
    ...
    title: 'Photography',
    description:
      'Visual storytelling through a cinematic lens. We provide art direction and photography that captures the mood, texture, and soul of your products and spaces.',
      ...
      <header className="relative min-h-screen flex items-center justify-center bg-background-light dark:bg-matte-black overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <motion.h1
            ...
            className="font-serif text-5xl md:text-8xl lg:text-9xl mb-6 tracking-tight text-gray-900 dark:text-white"
          >
          ...
          >
            We craft digital experiences that merge purpose with pixel-perfect precision. Our approach is holistic,
            minimal, and relentlessly focused on impact.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <a
              href="#services-start"
              className="inline-flex flex-col items-center gap-2 text-[10px] uppercase tracking-[0.3em] hover:opacity-70 transition-opacity text-gray-900 dark:text-white group"
            >
      ...
      <main id="services-start">
        {services.map((service, idx) => (
          <section
            ...
            className={`min-h-screen flex items-center py-24 ${
              idx % 2 === 0
                ? 'bg-white dark:bg-soft-charcoal'
                : 'bg-gray-50 dark:bg-matte-black'
            } relative border-t border-gray-200 dark:border-gray-900`}
          >
            <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div
                ...
                transition={{ duration: 0.8 }}
                className={`${
                  idx % 2 === 0 ? 'order-2 lg:order-1' : 'order-2'
                } relative h-[600px] w-full group overflow-hidden rounded-sm`}
              >
                <img
                  src={service.image}
                  alt={service.title}
              ...
              >
                <div className="glass-panel-light dark:glass-panel p-10 md:p-14 rounded-sm">
                  <span className="block text-[10px] font-bold tracking-[0.3em] uppercase text-gray-400 mb-4">
                    {service.number}
                  </span>
                  <h2 className="font-serif text-4xl md:text-6xl mb-8 text-gray-900 dark:text-white">
                    {service.title}
                  </h2>
                  ...
                  <ul className="space-y-4 font-sans border-t border-gray-300 dark:border-gray-700 pt-8">
                    {service.details.map((detail) => (
                      <li key={detail} className="flex items-center justify-between group cursor-default">
                        <span className="text-gray-500 dark:text-gray-400 group-hover:text-black dark:group-hover:text-white transition-colors font-light tracking-wide">
                          {detail}
                        </span>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {processSteps.map((step, idx) => (
                ...
                >
                  <div className="text-4xl text-gray-300 dark:text-gray-700 font-serif group-hover:text-black dark:group-hover:text-white transition-colors">
                    {step.number}
                  </div>
                  <div>
        ...
        <section className="py-32 bg-gray-50 dark:bg-matte-black relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            <a
              href="/contact"
              className="inline-block px-12 py-5 border border-gray-900 dark:border-white text-gray-900 dark:text-white text-[10px] uppercase tracking-[0.3em] font-bold hover:bg-gray-900 hover:text-white dark:hover:bg-white dark:hover:text-black transition-all duration-500"
            >
              Get in Touch
            </a>
          </div>
