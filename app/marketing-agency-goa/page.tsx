          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-ink/80 mb-8 leading-relaxed">
                Pixel 'N' Purpose brings strategic branding, social-first campaigns, and digital marketing expertise to businesses across Goa and beyond.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-display text-3xl md:text-4xl font-bold text-ink mb-8 text-center">
                Why Goa Businesses Choose Pixel 'N' Purpose
              </h2>
